...
public class GetMsgSendIntentApi extends BaseApiAgent {
        ...
        sendMsgResult.setResultCallback(new ResultCallback<IntentResult>() {
            ...
            public void onResult(IntentResult result) {
                if (result == null) {
                    ...
                    onSnsResult(HMSAgent.AgentResultCode.RESULT_IS_NULL, null);
                    return;
                }
                ...
                if (status == null) {
                    ...
                    onSnsResult(HMSAgent.AgentResultCode.STATUS_IS_NULL, null);
                    return;
                }
                ...
                if ((rstCode == CommonCode.ErrorCode.SESSION_INVALID
                    ...
                    if (nxtIntent == null) {
                        ...
                        onSnsResult(rstCode, nxtIntent);
                        return;
                    }

                }else {
                    onSnsResult(rstCode, null);
                }
            }
        });
    }

    void onSnsResult(int rstCode, Intent intent) {
        HMSAgentLog.d("callback=" + handler +" retCode=" + rstCode);
        if (handler != null) {
            handler.onResult(rstCode, intent);
            handler = null;
        }
        msg = null;
        needResult = false;
    ...
    public void getMsgSendIntent(SnsMsg msg, boolean needResult, GetMsgSendIntentHandler handler){
        HMSAgentLog.d("msg=" + msg + "  needResult=" + needResult + "  handler=" + handler);
        this.msg = msg;
